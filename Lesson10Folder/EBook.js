...
export class EBook extends Book{
    ...
    printInfo() {
        console.log(`The book title is ${this.title}, the author is ${this.author} and it was published in ${this.publishYear}. You can download the Ebook in ${this.fileFormat} format`)
    }
    static convertToEBook(bookInstance, fileFormat) {
        ...
        return new EBook(bookInstance.title, bookInstance.author, bookInstance.publishYear, fileFormat);
    }
    get fileFormat() {
