...
export class Book {
    ...
    printInfo() {
        console.log(`The book title is ${this.title}, the author is ${this.author} and it was published in ${this.publishYear}`)
    } 
    static findOldestBook(books){return books.reduce((oldest, current) => {
